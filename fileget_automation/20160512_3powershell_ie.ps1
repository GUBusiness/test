...
#DLするファイル名記載ファイルの絶対パス
$File_Base1 = 'C:\Users\ari\Desktop\fileget_automation\DLファイル名.txt'
$Base1_URL = 'C:\Users\ari\Desktop\fileget_automation\拠点AList.txt'
...
Remove-Item $Base1_URL
#ファイル名リストの内容のリンクを取得して、ファイル出力
#$File_Base1に記載されているファイル名数文ループ
$f = 0;
...
$baselink = Get-Content $Base1_URL
Foreach($x in $baselink){
#お試し
Start-Sleep -milliseconds 2000
$ie=new-object -com InternetExplorer.Application
$ie.visible=$true
